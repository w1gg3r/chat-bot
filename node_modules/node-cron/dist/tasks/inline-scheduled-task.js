...
class InlineScheduledTask {
    constructor(cronExpression, taskFn, options) {
        ...
        this.name = (options === null || options === void 0 ? void 0 : options.name) || this.id;
        this.timezone = options === null || options === void 0 ? void 0 : options.timezone;
        this.timeMatcher = new time_matcher_1.TimeMatcher(cronExpression, options === null || options === void 0 ? void 0 : options.timezone);
    ...
    execute() {
        return new Promise((resolve, reject) => {
            const onFail = (context) => {
                ...
                reject((_a = context.execution) === null || _a === void 0 ? void 0 : _a.error);
            };
            const onFinished = (context) => {
                var _a;
                this.off('execution:failed', onFail);
                resolve((_a = context.execution) === null || _a === void 0 ? void 0 : _a.result);
            };
